...
train_data, train_labels = dataset.create_sequences(data[:split], seq_length)
test_data, test_labels = dataset.create_sequences(data[split:], seq_length)
...
for epoch in range(num_epochs):
    for i in range(train_data.shape[0]):
        ...
        if count % 250 == 0:
            ...
            print('Iteration: {}  Loss: {}  Accuracy: {} %'.format(count, loss, accuracy/total))
